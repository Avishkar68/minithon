...
const Rooms = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-2 pt-30 min-h-screen justify-center lg:justify-start">
      <div className=" md:sticky top-24 self-start w-[90vw] mb-2 md:w-[280px] flex-none pb-9 border border-black/5 ml-4 h-fit bg-white rounded-2xl shadow-lg p-4 overflow-y-auto">
